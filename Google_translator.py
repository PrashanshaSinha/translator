...
lab_txt=Label(root,text="Source Text",font=("Times New Roman",20,"bold"),fg="Black",bg="Yellow")
...
lab_txt=Label(root,text="Destination Text",font=("Times New Roman",20,"bold"),fg="Black",bg="Yellow")
